{:namespaces
 ({:source-url
  ...
  {:source-url
   ...
   :doc nil}
  {:source-url
   "https://github.com/clojure/tools.analyzer.jvm/blob/4db2a9baa58d202383f036312f94befb535d2745/src/main/clojure/clojure/tools/analyzer/passes/jvm/validate_loop_locals.clj",
   :wiki-url
